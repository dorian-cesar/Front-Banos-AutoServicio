...
const translations = {
  ...
  pt: {
    ...
    "page.loading": "Carregando serviços",
    "page.errorLoading": "Não foi possível carregar os serviços",
    ...
    "page.cannotCreateAccessTryAgain": "Não foi possível criar acesso. Tente novamente.",
    "page.accept": "Aceitar",
    "page.paymentApproved": "Pagamento Aprovado",
